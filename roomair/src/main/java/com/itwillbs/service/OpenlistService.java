...
public class OpenlistService {
	...
	public int countProd(ProdDTO dto) {
		return pdao.countProd(dto);
	}

	// 품목관리 검색리스트 불러오기

	public List<ProdDTO> getProdList(ProdDTO dto, RequirementPageDTO pdto) throws Exception {
	...
	public int countRaw(RawmaterialsDTO dto) {
		return pdao.countRaw(dto);
	}

	// 원자재관리 검색 리스트

	public List<RawmaterialsDTO> getRawList(RawmaterialsDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.readRawList(dto, pdto);
	}
	...
	public int countClient(ClientDTO dto) {
		return pdao.countClient(dto);
	}

	public int buycountClient(ClientDTO dto) {
		return pdao.buycountClient(dto);
	}

	public int sellcountClient(ClientDTO dto) {
		return pdao.sellcountClient(dto);
	}

	// 거래처목록 검색 리스트

	public List<ClientDTO> getClientList(ClientDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.readClientList(dto, pdto);
	}

	public List<ClientDTO> buygetClientList(ClientDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.buyreadClientList(dto, pdto);
	}

	public List<ClientDTO> sellgetClientList(ClientDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.sellreadClientList(dto, pdto);
	}
	...
	public int countSell(SellDTO dto) {
		return pdao.countSell(dto);
	}

	// 수주목록 검색 리스트

	public List<SellDTO> getSellList(SellDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.readSellList(dto, pdto);
	}
	...
	public int countWhse(WarehouseDTO dto) {
		return pdao.countWhse(dto);
	}

	// 거래처목록 검색 리스트

	public List<WarehouseDTO> getWhseList(WarehouseDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.readWhseList(dto, pdto);
	}
	...
	public int countEmp(EmployeesDTO dto) {
		return pdao.countEmp(dto);
	}

	// 직원목록 검색 리스트

	public List<EmployeesDTO> getEmpList(EmployeesDTO dto, RequirementPageDTO pdto) throws Exception {
		return pdao.readEmpList(dto, pdto);
	}

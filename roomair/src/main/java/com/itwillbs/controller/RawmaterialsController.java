...
public class RawmaterialsController {
    ...
    public String detail(RawmaterialsDTO rawmaterialsDTO, Model model) {
        ...
        // 1) rawmaterialsService, rawmaterialsDAO에 getDetail 메서드를 만들어, 들고온 a1에 해당하는 다른
        // 내용 a2, a3 등을 가져오게 하고 => rawmaterialsDTO 변수에 담기
    ...
    public String updatePro(RawmaterialsDTO rawmaterialsDTO) {
        ...
        // 따라서 boardDTO = boardService.updateBoard(boardDTO);처럼 boardDTO에 받아올 필요없고,

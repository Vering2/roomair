...
//------------------------------------------------------- 수주 조회 -----------------------------------------------
	...
	public String sellMainSearch(Model model, HttpServletRequest request, SellDTO sellDTO) {
		...
		if ("".equals(sellDTO.getClientCode()) || "null".equals(sellDTO.getClientCode())
				|| sellDTO.getClientCode() == null) {
		...
		if ("".equals(sellDTO.getSellState()) || "null".equals(sellDTO.getSellState())
				|| sellDTO.getSellState() == null) {
			System.out.println("수주코드 변경");

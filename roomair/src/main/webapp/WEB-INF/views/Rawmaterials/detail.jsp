...
<body>
	<div class="content">
		...
		<table>
			<tr>
				<td id="td1">원자재코드</td>
				<td id="td21">${rawmaterialsDTO.rawCode}</td>
			</tr>
			<tr>
				<td id="td1">원자재명</td>
				<td id="td22">${rawmaterialsDTO.rawName}</td>
			</tr>
			<tr>
				<td id="td1">종류</td>
				<td id="td21">${rawmaterialsDTO.rawType}</td>
			</tr>
			<tr>
				<td id="td1">단위</td>
				<td id="td22">${rawmaterialsDTO.rawUnit}</td>
			</tr>
			<tr>
				<td id="td1">매입단가</td>
				<td id="td21">${rawmaterialsDTO.rawPrice}</td>
			</tr>
			<tr>
				<td id="td1">창고명</td>
				<td id="td22">${rawmaterialsDTO.whseCode}</td>
			</tr>
			<tr>
				<td id="td1">비고</td>
				<td id="td21">${rawmaterialsDTO.rawMemo}</td>
			</tr>
		</table>

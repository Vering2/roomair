	...
	<div class="sidebar">
		<div class="sidebody">
			<div class="logininfo">
				...
				<div id="logo">
					<a href="${pageContext.request.contextPath }/main/calendar"> <img src="${pageContext.request.contextPath }/resources/img/logo.png">
					</a>
				</div>
				<!-- 			로고자리 -->
			...
			<ul id="sideaccordion" class="sideaccordion">
				<li>
					...
					<ul class="submenu">
						...
						<li><a href="${pageContext.request.contextPath }/product/list" class="sidea">품목관리</a></li>
				...
				<li>
					...
					<ul class="submenu">
						...
						<li><a href="${pageContext.request.contextPath }/workorder/workOrderList" class="sidea">작업지시관리</a></li>
				...
				<li>
					<div class="sidelink">
						<i class="fa-solid fa-warehouse"></i>자재관리<i class="fa-solid fa-angle-down"></i>
					</div>
					<ul class="submenu">
						<li><a href="${pageContext.request.contextPath }/stock/listraw" class="sidea">재고관리</a></li>
			...
			<div class="logininfo" style="text-align: center;">
				<p>
					<a href="${pageContext.request.contextPath}/login/logout" style="color: #929FA8; text-decoration: none;">로그아웃</a>
				<p>
			</div>
		</div>

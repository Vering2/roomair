...
<script type="text/javascript">
	...
	function newTabUpdate() {
		...
		window
				.open(
						"${pageContext.request.contextPath}/stock/updateR?stockNum="
								+ ch,
						"수정",
	...
	<div class="container">
		...
		<div id="searchform">
			<form action="${pageContext.request.contextPath}/stock/listraw" method="get" id="selected">
				<label>원자재코드</label> <input type="text" name="search1" placeholder="원자재코드"> <label>창고코드</label> <input type="text" name="search2" placeholder="창고코드">

...
<body>
	<div class="content">
		...
		<table>
			<tr>
				<td id="td1">발주코드</td>
				<td id="td21">${ordermanagementDTO.buyNum}</td>
			</tr>
			<tr>
				<td id="td1">품번</td>
				<td id="td22">${ordermanagementDTO.rawCode}</td>
			</tr>
			<tr>
				<td id="td1">품명</td>
				<td id="td21">${ordermanagementDTO.rawName}</td>
			</tr>
			<tr>
				<td id="td1">종류</td>
				<td id="td22">${ordermanagementDTO.rawType}</td>
			</tr>
			<tr>
				<td id="td1">거래처코드</td>
				<td id="td21">${ordermanagementDTO.clientCode}</td>
			</tr>
			<tr>
				<td id="td1">창고코드</td>
				<td id="td22">${ordermanagementDTO.whseCode}</td>
			</tr>
			<tr>
				<td id="td1">창고명</td>
				<td id="td21">${ordermanagementDTO.whseName}</td>
			</tr>
			<tr>
				<td id="td1">재고수량</td>
				<td id="td22">${ordermanagementDTO.stockCount}</td>
			</tr>
			<tr>
				<td id="td1">발주수량</td>
				<td id="td21">${ordermanagementDTO.buyCount}</td>
			</tr>
			<tr>
				<td id="td1">매입단가</td>
				<td id="td22">${ordermanagementDTO.rawPrice}</td>
			</tr>
			<tr>
				<td id="td1">단가총계</td>
				<td id="td21">${ordermanagementDTO.rawPrice * ordermanagementDTO.buyCount}</td>
			</tr>
			<tr>
				<td id="td1">발주신청일</td>
				<td id="td22">${ordermanagementDTO.buyDate}</td>
			</tr>
			<tr>
				<td id="td1">발주상태</td>
				<td id="td21">${ordermanagementDTO.buyInstate}</td>
			</tr>
			<tr>
				<td id="td1">담당자</td>
				<td id="td22">${ordermanagementDTO.buyEmpId}</td>
			</tr>
		</table>

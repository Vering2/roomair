...
<body>
	...
	<div class="container">
		<h2>
			<a href="${pageContext.request.contextPath}/employees/employees" style="text-decoration: none; color: black;">인사 관리</a>
		</h2>
		...
		<div id="searchForm">
			<form action="${pageContext.request.contextPath}/employees/employees" method="get" id="searchBox">
				<div id="searchform" style="border-radius: 5px;">
					<label>통합 검색</label><input type="text" name="search"> <input type="submit" value="조회" id="searchButton">
				</div>
			</form>
		</div>

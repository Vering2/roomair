	...
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/employees/updatePro" id="join" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<p>사원번호</p>
				<input type="text" name="empId" class="empId" value="${employeesDTO.empId}" readonly="readonly">
			</div>
			<div class="form-group">
				<p>비밀번호</p>
				<input type="password" name="empPass" class="empPass" value="${employeesDTO.empPass}">
			</div>
			<div class="form-group">
				<p>사원명</p>
				<input type="text" id="empName" name="empName" class="empName" value="${employeesDTO.empName}">
			</div>
			...
			<div class="form-group">
				<p>이메일</p>
				<input type="email" id="empEmail" name="empEmail" class="empEmail" value="${employeesDTO.empEmail}">
			</div>
			<span id="empEmailmsg"> </span>
			<div class="form-group">
				<p>전화번호</p>
				<input type="text" id="empTel" name="empTel" class="empTel" placeholder="-없이 입력하세요." value="${employeesDTO.empTel}" maxlength=11>
			</div>
			<span id="empTelmsg"> </span>
			<div class="form-group">
				<p>입사일자</p>
				<input type="date" name="empHiredate" class="empHiredate" value="${employeesDTO.empHiredate}">
			</div>
			<div class="form-group">
				<p>재직구분</p>

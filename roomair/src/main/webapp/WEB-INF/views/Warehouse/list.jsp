...
<link href="${pageContext.request.contextPath }/resources/css/warehouse.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
	...
	function newTabInsert() {
		window
				.open(
						"${pageContext.request.contextPath}/Warehouse/write",
						"추가",
						"location=0,status=1,scrollbars=1,resizable=1,menubar=0,toolbar=no,width=530,height=530");
	}
	...
	function newTabUpdate() {
		...
		window
				.open(
						"${pageContext.request.contextPath}/Warehouse/update?whseCode="
								+ ch,
						"수정",
						"location=0,status=1,scrollbars=1,resizable=1,menubar=0,toolbar=no,width=530,height=530");
	}
	...
	<div class="container">
		...
		<div id="searchform">
			<form action="${pageContext.request.contextPath}/Warehouse/list" method="get" id="selected">
				<label>창고코드</label> <input type="text" name="search1" placeholder="창고코드"> <label>창고이름</label> <input type="text" name="search2" placeholder="창고이름"> <label>창고타입</label> <select name="search3">

...
<body>
	...
	<div id="con">
		<h2>입고 관리</h2>
		<div id="searchForm">
			<label>입고 코드</label> <input type="text" name="inNum" id="inNum" placeholder="입고 코드"> <label>원자재명</label> <input type="text" name="rawName" id="rawName9999" placeholder="원자재명" onclick="searchItem('raw','rawCode9999')" style="cursor: pointer;"> <label>거래처명</label> <input type="text" name="clientCompany" id="clientCompany9999" placeholder="거래처" style="cursor: pointer;" onclick="searchItem('client','clientCode9999')"> <input type="button" value="조회" id="searchButton"> <input type="button" value="초기화" id="resetButton">
		</div>
		<div id="buttons">
			<input type="button" value="전체" id="allButton" class="buttons highlighted"> <input type="button" value="미입고" id="non_inButton" class="buttons"> <input type="button" value="입고부족" id="re_inButton" class="buttons"> <input type="button" value="입고" id="inButton" class="buttons">
									...
									window
											.open(
													contextPath
															...
															+ inNum, "입고 상세정보",
													"width=500,height=700,toolbar=no,location=no,resizable=yes");
								});
						...
						function() {
							if (!(department !== ADMIN_DEPARTMENT && department !== "관리자")) {
								...
								var searchParams = {
									inNum : $("#inNum").val(),
									rawName : $("#rawName9999").val(),
									clientCompany : $("#clientCompany9999")
											.val(),
									inState : inStateButton1
								};

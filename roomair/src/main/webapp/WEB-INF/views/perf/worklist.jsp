	...
	<table class="ct" id="ct">
		...
		<tbody>
			<c:forEach var="workorderDTO" items="${worklist}">
				<tr class="ctcontents">
					<!-- 0 넘김-->
					<td>${workorderDTO.workCode}</td>
					<!-- 1 넘김-->
					<td>${workorderDTO.lineCode}</td>
					<!-- 2 안넘김-->
					<td>${workorderDTO.sellCode}</td>
					<!-- 3 넘김-->
					<td>${workorderDTO.prodCode}</td>
					<!-- 4 안넘김-->
					<td>${workorderDTO.workDate}</td>
					<!-- 5 넘김-->
					<td>${workorderDTO.workAmount}</td>
					<!-- 6 넘김-->
					<td>${workorderDTO.workProcess}</td>
				</tr>
			</c:forEach>

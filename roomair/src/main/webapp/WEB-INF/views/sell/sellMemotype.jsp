		...
		<c:choose>
			<c:when test="${memotype == 'add'}">
				...
				<form class="popup" method="post" action="${pageContext.request.contextPath}/sell/sellMemotypePro">
					<textarea id="sellMemo" style="width: 300px; height: 250px;" name="sellMemo"></textarea>
					<br> <input type="hidden" name="sellCode" value="${sellDTO.sellCode}" />
					<div class="btn">
			...
			<c:otherwise>
				...
				<form class="popup" method="post" action="${pageContext.request.contextPath}/sell/sellMemoUpdatePro">
					<textarea id="sellMemo" style="width: 300px; height: 250px;" name="sellMemo">${sellDTO.sellMemo}</textarea>
					<br> <input type="hidden" name="sellCode" value="${sellDTO.sellCode}" />

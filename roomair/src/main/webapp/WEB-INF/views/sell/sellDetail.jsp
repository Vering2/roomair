		...
		<c:when test="${!(empty sessionScope.empDepartment)}">
			<div class="popupContainer" id="body">
				...
				<form action="${pageContext.request.contextPath}/sell/sellUpdatePro" id="popup" class="popup" method="post" onsubmit="checkForm()">
					<label>수주 코드</label> <input type="text" style="width: 130px;" name="sellCode" value="${sellDTO.sellCode}" readonly> <br> <label>처리 상태</label> <input type="text" name="sellState" value="${sellDTO.sellState}" readonly> <br> <label>거래처</label> <input type="text" name="clientCode" value="${sellDTO.clientCode}" readonly> <input type="text" value="${sellDTO.clientCompany}" readonly> <br> <label>제품</label> <input type="text" name="prodCode" value="${sellDTO.prodCode}" readonly> <input type="text" name="prodName" value="${sellDTO.prodName}" readonly> <br> <label>제품 단가</label> <input type="text" name="prodPrice" value="${sellDTO.prodPrice}" readonly>원 <br> <label>수주 수량</label> <input type="number" id="sellCount" name="sellCount" value="${sellDTO.sellCount}" readonly>개 <br> <label>수주 단가</label> <input type="text" step="0.01" name="prodPrice"
						value="<fmt:formatNumber type="number" maxFractionDigits="2" value="${sellDTO.sellPrice}" pattern="###,###" />" id="calculateSellPrice" readonly
					/> <br> <label>수주 일자</label> <input type="text" id="sellDate" name="sellDate" value="${sellDTO.sellDate}" readonly> <br> <label>납기 일자</label> <input type="text" id="sellDate" name="sellDate" value="${sellDTO.sellDuedate}" readonly> <br> <label>담당자</label> <input type="text" name="sellEmpId" value="${sellDTO.sellEmpId}" readonly> <br> <label>비고</label> <br>

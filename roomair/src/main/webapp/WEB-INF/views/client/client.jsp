...
<body>
	...
	<div class="clientBody">
		<h1 class="toptitle">
			<a href="${pageContext.request.contextPath}/client/client" style="text-decoration: none; color: black; font-weight: bold;">거래처 관리</a>
		</h1>


		<form method="GET">
			<div class="search">
				<label class="searchlabel">거래처명&nbsp;&nbsp;</label><input type="text" id="clientCompany" name="clientCompany"> &nbsp;&nbsp; <input type="submit" class="searchbtn" value="조회">

			</div>

			<div class="typetab">
				<input type="submit" id="clientType" name="clientType" value="전체"> <input type="submit" id="clientType" name="clientType" value="수주처"> <input type="submit" id="clientType" name="clientType" value="발주처">
			</div>
		</form>
		<!--  본문 내용  -->
		<div class="clientbody1">
			<div class="tableform">
				...
				<div class="clienttotal">
					<h2 class="h2class">
						총 ${pageDTO.count} 건 &nbsp;&nbsp;<span class="notificlient">* 거래처명을 클릭하면 상세하게 볼 수 있습니다.</span>
					</h2>

					<div style="float: right;">
						<input type="button" value="추가" id="addButton" class="addbutton" onclick="perfInsert()">
					</div>
					...
					<tbody>
						<c:forEach var="clientDTO" items="${clientList}">
							<tr>
								...
								<td class="cttg" onclick="openClientDetail('${clientDTO.clientCompany}')" id="click">${clientDTO.clientCompany}</td>
	...
	<script>
		...
		function openClientDetail(clientCompany) {
			var url = '${pageContext.request.contextPath}/client/clientdetail?clientCompany='
					+ clientCompany;
			window.open(url, '_blank',
					'width=470px, height=650px, left=600px, top=100px');
		}
	</script>
</body>
</html>
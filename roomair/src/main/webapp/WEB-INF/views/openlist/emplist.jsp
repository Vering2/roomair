...
<body>
	<div class="right_col">
		...
		<h1 style="margin-left: 1%;">${dto.empDepartment}직원목록</h1>


		<form method="get">
			<fieldset>

				<input type="hidden" name="input" id="input" value="${input }"> <label>아이디&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="empId" id="searchCode" placeholder="코드를 입력하세요."> &nbsp;&nbsp; <label>이름&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="empName" id="searchName" placeholder="거래처를 입력하세요."> &nbsp;&nbsp; <input hidden name="type2" value="${dto.empDepartment}"> <input type="submit" class="button" value="조회">
				...
				<div class="x_content">
					<div class="table-responsive">
						<div class="table-wrapper">
							...
							<table id="empTable" class="table table-striped jambo_table bulk_action" style="text-align-last: center;">
								<thead>
									<tr class="headings">
										<th>번호</th>
										<th>아이디</th>

	...
	<div class="right_col">
		...
		<form method="get">
			<fieldset>
				...
				<input type="hidden" name="input" id="input" value="${input }"> <label>코드&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="whseCode" id="searchCode" onfocus="this.value='WH'" placeholder="코드를 입력하세요."> &nbsp;&nbsp; <label>창고명&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="whseName" id="searchName" placeholder="창고명을 입력하세요."> &nbsp;&nbsp; <input type="submit" class="button" value="조회">
				...
				<div class="x_content">
					<div class="table-responsive">
						<div class="table-wrapper">
							...
							<table id="whseTable" class="table table-striped jambo_table bulk_action" style="text-align-last: center;">
								<thead>
									<tr class="headings">
										<th>번호</th>
										<th>코드</th>

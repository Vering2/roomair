...
<body>
	<div class="right_col">
		...
		<form method="get">
			<fieldset>
				<input type="hidden" name="input" id="input" value="${input }"> <label>코드&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="rawCode" id="searchCode" onfocus="this.value='RM'" placeholder="코드를 입력하세요."> &nbsp;&nbsp; <label>원자재&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="rawName" id="searchName" placeholder="원자재를 입력하세요."> &nbsp;&nbsp; <input type="submit" class="button" value="조회">
			</fieldset>
		</form>

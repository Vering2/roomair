	...
	<div class="right_col">
		...
		<form method="get">
			<fieldset>
				...
				<input type="hidden" name="input" id="input" value="${input }"> <label>코드&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="prodCode" id="searchCode" onfocus="this.value='PR'" placeholder="코드를 입력하세요."> &nbsp;&nbsp; <label>제품&nbsp;</label> <input style="width: 175; font: 500 15px/15px 'Inter', sans-serif;" class="input_box" type="text" name="prodName" id="searchName" placeholder="제품을 입력하세요."> &nbsp;&nbsp; <input type="submit" class="button" value="조회">
				...
				<div class="x_content">
					<div class="table-responsive">
						<div class="table-wrapper">
							...
							<table id="productTable" class="table table-striped jambo_table bulk_action" style="text-align-last: center;">
								<thead>
									<tr class="headings">
										<th>번호</th>
										<th>코드</th>
		...
		<div class="page_nation" style="text-align: center; font-size: 0; position: absolute; bottom: 1%; right: 1%;">
			...
			<c:forEach begin="${paging.startPage }" end="${paging.endPage }" var="p">
				...
				<c:choose>
					...
					<c:otherwise>
						<a class="a" href="${pageContext.request.contextPath}/search/product?nowPage=${p }&cntPerPage=${paging.cntPerPage}&prodCode=${dto.prodCode }&prodName=${dto.prodName }">${p }</a>
					</c:otherwise>
				</c:choose>
